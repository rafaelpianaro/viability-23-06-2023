"""
Django settings for viability project.
...
SECRET_KEY = 'django-insecure-_w*bs)5gc2s=w($d=a^k(e(l6xuge$*z42l4)4430rz$ud*il6'
...
WSGI_APPLICATION = 'viability.wsgi.application'
